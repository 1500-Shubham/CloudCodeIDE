...
export const Editor = ({
  ...
  const rootDir = useMemo(() => {
    ...
    // here build converting backend RemoteFile => Directory (for Code Sand Box Open Source)
    // that openSource understands files and Directory in its defined way file-manager.tsx
  }, [files]);
